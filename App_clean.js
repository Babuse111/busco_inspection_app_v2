...
export default function App() {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.welcomeContainer}>
        <View style={styles.logoContainer}>
          <Text style={styles.logo}>buscor</Text>
        ...
        >
          ...
          <View style={styles.optionContent}>
            ...
            <Text style={styles.optionDescription}>Manage operations</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View style={styles.optionContent}>
            <Text style={styles.optionTitle}>Driver/Mechanic/Team Login</Text>
            <Text style={styles.optionDescription}>Perform inspections, maintenance</Text>
          </View>
        </TouchableOpacity>
  ...
  const renderAdminLogin = () => (
    <SafeAreaView style={styles.container}>
      <View style={styles.loginContainer}>
        <View style={[styles.loginIcon, styles.adminLoginIcon]}>
  ...
  const renderDriverLogin = () => (
    <SafeAreaView style={styles.container}>
      <View style={styles.loginContainer}>
        <View style={[styles.loginIcon, styles.driverLoginIcon]}>
          <Text style={styles.loginIconText}>🚌</Text>
        </View>
        ...
        <TouchableOpacity 
          style={[styles.proceedButton, styles.driverProceedButton]}
          onPress={() => setCurrentScreen('inspection')}
        >
          <Text style={styles.proceedButtonText}>Proceed to Inspection</Text>
        </TouchableOpacity>
